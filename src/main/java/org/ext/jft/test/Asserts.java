...
public class Asserts {
	...
	public static <T> void assertCollectionEquals(Collection<T> expecteds, Collection<T> actuals) {
	...
	public static <K, V> void assertMapEquals(Map<K, V> expecteds, Map<K, V> actuals) {
